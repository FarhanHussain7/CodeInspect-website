...
const HomePage = () => {
  ...
  return (
    <div id="home" className="text-white font-sans ">
      ...
      {/* HERO SECTION */}
      <div className="relative flex flex-col items-center justify-center w-full min-h-[60vh] pt-40 pb-30 z-10 text-white text-center px-4 pointer-events-none">
        <h1 className="text-[11vw] font-extrabold tracking-wide font-[Host_Grotesk] text-center mb-2">
          CodeInspects
        </h1>
        <p className="text-xl font-[Host_Grotesk] tracking-wider text-center mb-2">- Build Better. Test Smarter. Launch Faster - </p>
      </div>
      <div className="relative z-0">
